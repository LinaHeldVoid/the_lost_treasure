...
from console_game.service_fuctions import print_effect as p_e, sound_effect as s_e, wrong_input as w, \
    quit_menu as q, random_no as r_n, death
    ...
    while True:
        ...
        if option == '100':
            ...
            while True:
                ...
                if option == '1':
                    while True:
                        death(t_settings, v_p_settings, v_a_settings)
                        continue
                elif option == '2':
                    g = set_generator(39)
                                        ...
                                        if option == '1':
                                            ...
                                            while True:
                                                if diamond_is_taken:
                                                    ...
                                                    s_e('sound/voice_actions/option.wav', v_a_settings)
                                                    time.sleep(2) if not t_settings and v_a_settings else None
                                                    record = s_e('sound/voice_actions/18_fm_2.wav', v_a_settings)
                                                    option = input('Введите цифру: ')
                                                    record.stop() if v_a_settings else None
                                                    if option == '1':
                                                        r_n(t_settings, v_p_settings, no_use)
                                                    ...
                                                    s_e('sound/voice_actions/option.wav', v_a_settings)
                                                    time.sleep(2) if not t_settings and v_a_settings else None
                                                    record = s_e('sound/voice_actions/19_fm_3.wav', v_a_settings)
                                                    option = input('Введите цифру: ')
                                                    record.stop() if v_a_settings else None
                                                    if option == '1':
                                                        r_n(t_settings, v_p_settings, no_use)
